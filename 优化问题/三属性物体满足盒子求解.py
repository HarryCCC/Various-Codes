...
boxes = [
    {"A_box": 155, "B_box": 75, "C_box": 240, "objects": []},
    {"A_box": 210, "B_box": 136, "C_box": 55, "objects": []},
    {"A_box": 65, "B_box": 189, "C_box": 175, "objects": []},
    {"A_box": 110, "B_box": 150, "C_box": 140, "objects": []}
]
...
def find_solution():
    # 生成所有可能的三个物体的组合
    combinations = list(itertools.combinations(range(28), 3))
    # 遍历所有的组合
