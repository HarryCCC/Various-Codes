...
看吧，我就说诚实总是爱情里最重要的一件事之一。没了这东西，人便成了只要相信那嘴里吐露出来的说法的玩艺儿，正与听听便信了的AI无异了。
...
幸运的是，现代科技辅助下，实时通讯促进了更频繁的语言沟通，而语言就是思维交流的最绝对重要载体。可惜的是，语言永远是不完全的。从思维到语言，需要经历大脑的“理解来信→推理→组织语言”的简化流程，仅仅如此，就难以避免信息的损失。更何况，存在不完全诚实的信息主动保留，这无法避免，因为人的诚实程度是从0-99的过程，百分百的诚实意味着不顾虑任何的意见表达，这应当是糟糕的。
