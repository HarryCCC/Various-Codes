...
#筛风险回报和基本面
#filter_col_indices = range(total_columns - 6, total_columns) 
#只筛基本面,筛选最后四列
filter_col_indices = range(total_columns - 3, total_columns) 
...
# 输出排序后的结果到txt文件
with open('predict/predictions.txt', 'w') as file:
    # 首先输出预期结果最高的五只股票的代码
