...
def calculate_test_hands(weights, closing_prices, budget=550000, shares_per_hand=100):
    """
...
# Select the stocks with weights > 2% from the Optimal Risky Portfolio
...
with open("筛选投资组合手数.txt", "w") as file:
